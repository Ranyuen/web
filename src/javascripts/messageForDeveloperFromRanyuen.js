...
(function () {
  ...
  console.log('%cRanyuen%c are working to %cmake smile over the world by Japanese orchids%c.',
    ...
    'font-weight: bold;',
    'font-weight: normal;');
  console.log('This website is devloping at GitHub %o.',
    'https://github.com/Ranyuen/web');
  console.log('We are in Japan, and if you want to work with us, please e-mail.');
  console.log('%ccal_pone@ranyuen.com',
